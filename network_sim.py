...
for g in gvariable:
    ...
    # L4 spikes
    np.save('E:\\Zeldenrust lab\\pythoncodes\\balanced_state\\dataset25\\baseline\\Spikestest_4e_i_g=%g_r=%g' %(g,r), spikemon_4_e.i)
    np.save('E:\\Zeldenrust lab\\pythoncodes\\balanced_state\\dataset25\\baseline\\Spikestest_4e_t_g=%g_r=%g' %(g,r), spikemon_4_e.t)
    np.save('E:\\Zeldenrust lab\\pythoncodes\\balanced_state\\dataset25\\baseline\\Spikestest_4i_i_g=%g_r=%g' %(g,r), spikemon_4_i.i)
    np.save('E:\\Zeldenrust lab\\pythoncodes\\balanced_state\\dataset25\\baseline\\\\Spikestest_4i_t_g=%g_r=%g' %(g,r), spikemon_4_i.t)
    # spike trains
    np.save('E:\\Zeldenrust lab\\pythoncodes\\balanced_state\\dataset25\\baseline\\Spiketraintest_4e_g=%g_r=%g' %(g,r), [spikemon_4_e.spike_trains()])
    np.save('E:\\Zeldenrust lab\\pythoncodes\\balanced_state\\dataset25\\baseline\\Spiketraintest_4i_g=%g_r=%g' %(g,r), [spikemon_4_i.spike_trains()])

    # L2/3 spikes
    np.save('E:\\Zeldenrust lab\\pythoncodes\\balanced_state\\dataset25\\baseline\\Spikestest_23e_i_g=%g_r=%g' %(g,r), spikemon_23_e.i)
    np.save('E:\\Zeldenrust lab\\pythoncodes\\balanced_state\\dataset25\\baseline\\Spikestest_23e_t_g=%g_r=%g' %(g,r), spikemon_23_e.t)
    np.save('E:\\Zeldenrust lab\\pythoncodes\\balanced_state\\dataset25\\baseline\\Spikestest_23i_i_g=%g_r=%g' %(g,r), spikemon_23_i.i)
    np.save('E:\\Zeldenrust lab\\pythoncodes\\balanced_state\\dataset25\\baseline\\Spikestest_23i_t_g=%g_r=%g' %(g,r), spikemon_23_i.t)
    # spike trains
    np.save('E:\\Zeldenrust lab\\pythoncodes\\balanced_state\\dataset25\\baseline\\Spiketraintest_23i_g=%g_r=%g' %(g,r), [spikemon_23_i.spike_trains()])
    np.save('E:\\Zeldenrust lab\\pythoncodes\\balanced_state\\dataset25\\baseline\\Spiketraintest_23e_g=%g_r=%g' %(g,r), [spikemon_23_e.spike_trains()])